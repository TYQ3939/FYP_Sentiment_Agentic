...
class ScraperAgent(BaseAgent):
    """
    Collects comments via Arctic Shift (Reddit).

    Fallback chain when Reddit returns 0 comments:
    ...
    def run(self, user_request: str) -> dict:
        ...
        try:
            ...
            # Step 1 — LLM router: classify topic + pick subreddits + keywords
            ...
            if result.get("comments_count", 0) == 0:
                self.log("Arctic Shift returned 0 comments — trying YouTube fallback...")
                try:
